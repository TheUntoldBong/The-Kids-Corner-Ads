...
mixin _$CheckoutStore on CheckoutStoreBase, Store {
  ...
  final _$shipToDifferentAddressAtom =
      Atom(name: 'CheckoutStoreBase.shipToDifferentAddress');
  ...
  final _$progressServerAsyncAction =
      AsyncAction('CheckoutStoreBase.progressServer');
  ...
  final _$changeAddressAsyncAction =
      AsyncAction('CheckoutStoreBase.changeAddress');

  @override
  Future<void> changeAddress(
      {Map<String, dynamic>? billing, Map<String, dynamic>? shipping}) {
    return _$changeAddressAsyncAction
        .run(() => super.changeAddress(billing: billing, shipping: shipping));
  }

  final _$updateAddressAsyncAction =
      AsyncAction('CheckoutStoreBase.updateAddress');
  ...
  final _$CheckoutStoreBaseActionController =
      ActionController(name: 'CheckoutStoreBase');

  @override
  void onShipToDifferentAddress() {
    final $actionInfo = _$CheckoutStoreBaseActionController.startAction(
