...
class _NotificationDetailState extends State<NotificationDetail> with AppBarMixin, NavigationMixin, Utility {
  ...
  Widget build(BuildContext context) {
    ...
    TextStyle defaultStyle = textTheme.bodyText2!.copyWith(color: ColorBlock.blueGray);
    TextStyle linkStyle = textTheme.bodyText2!.copyWith(color: theme.primaryColor);
      ...
      child: Scaffold(
        ...
        body: Column(
          children: [
            NotificationItem(
              onTap: () {},
              title: Text(title, style: textTheme.subtitle2),
