...
class _ResultState extends State<Result> with LoadingMixin {
  ...
  void didChangeDependencies() {
    ...
    if (_appStore.getStoreByKey('product_search_${widget.search}') == null) {
      ...
      _productStore = _appStore.getStoreByKey('product_search_${widget.search}');
    }
  ...
  Widget build(BuildContext context) {
    ...
    return Observer(
      key: Key('product_search_${widget.search}'),
      builder: (context) {
