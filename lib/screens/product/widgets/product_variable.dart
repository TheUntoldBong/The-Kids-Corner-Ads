...
class Term extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (isSelected!) {
      return OutlinedButton(
        ...
        style: OutlinedButton.styleFrom(
          foregroundColor: theme.primaryColor, side: BorderSide(width: 2, color: theme.primaryColor),
    ...
    return OutlinedButton(
      ...
      style: OutlinedButton.styleFrom(
        foregroundColor: titleButton!.color, side: BorderSide(width: 1, color: theme.dividerColor),
        textStyle: titleButton,
        minimumSize: const Size(40, 0),
        padding: paddingHorizontal,
      ),
