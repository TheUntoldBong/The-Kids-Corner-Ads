...
class _TimeStampItemState extends State<TimeStampItem> {
      ...
      child: SizedBox(
        ...
        child: TextButton(
          ...
          style: TextButton.styleFrom(
            foregroundColor: _isPicked()
                ? theme.colorScheme.onPrimary
                : theme.textTheme.subtitle1?.color, padding: EdgeInsets.zero,
            minimumSize: const Size(0, 50),
            tapTargetSize: MaterialTapTargetSize.shrinkWrap,
            backgroundColor:
                _isPicked() ? theme.primaryColor : Colors.transparent,
            shape: RoundedRectangleBorder(
              side: BorderSide(
                  color: _isPicked() ? theme.primaryColor : theme.dividerColor),
            ),
          ),
          child: Column(
  ...
  _isPicked() {
    if (widget.pickedTime != null) {
      ...
      return (widget.dateTime.hour == widget.pickedTime!.hour &&
          widget.dateTime.minute == widget.pickedTime!.minute);
    }
    return false;
  }
}
