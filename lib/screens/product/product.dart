...
class _ProductScreenState extends State<ProductScreen>
  ...
  List<Widget> buildColumn(List<dynamic>? columns, {String? themeModeKey, String? languageKey}) {
    ...
    return columns.map((e) {
      ...
      String url = get(e, ['value', 'url', 'text'], '');
      
      double? height = ConvertData.stringToDouble(get(e, ['value', 'height'], '200'));
      
      bool syncAuth = get(e, ['value', 'syncAuth'], false);

      dynamic conditional = get(e, ['value', 'conditional'], null);
