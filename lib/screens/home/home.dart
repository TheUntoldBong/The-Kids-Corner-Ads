...
class _HomeScreenState extends State<HomeScreen> with Utility, MessagingMixin, NavigationMixin, InterstitialAdsMixin {
  ...
  void initState() {
    ...
    // Show ads
    if (interstitialAdsOptions['home'] == true) {
      showAds();
    }
  }
  ...
  Widget buildHome(DataScreen? data) {
    ...
    return AwesomeDrawerBar(
      ...
      mainScreen: WillPopScope(
        child: Scaffold(
          key: _scaffoldKey,
          persistentFooterButtons: bannerAdsOptions['home'] == true ? persistentFooterButtons(_authStore) : null,
