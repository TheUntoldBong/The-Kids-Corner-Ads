...
class _OrderDetailScreenState extends State<OrderDetailScreen>
  ...
  Widget build(BuildContext context) {
    ...
    TextStyle? itemStyle = textTheme.caption;
            ...
            children: [
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    buildItem(
                      ...
                      subTitle: formatDate(date: _orderData!.dateCreated!),
                    ),
                    buildItem(
                        padding: const EdgeInsetsDirectional.only(start: itemPaddingMedium),
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Text(price(_orderData!.shippingTotal), style: textTheme.subtitle2)
                            ],
                          )
                        ],
                      ),
              ...
              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                ...
                Column(
                  ...
                  children: [
                    Text(price(_orderData!.total), style: textTheme.headline6),
      ...
      children: [
        Padding(
          ...
          child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
            if (leading != null) Text(leading, style: textTheme.caption),
            Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                if (title != null) Text(title, style: textTheme.caption),
                if (subTitle != null) Text(subTitle, style: textTheme.subtitle2),
              ],
            ),
            if (trailing != null)
              Text(
